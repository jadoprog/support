...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 15 déc. 2021 à 17:34
...
INSERT INTO `message` (`id`, `id_exp`, `id_dest`, `cathegorie`, `message`, `status`, `vue`, `n_ticket`, `date`) VALUES
                                                                                                                    ...
                                                                                                                    (4, 2, 0, 'Formation exterieur', 'Sehe vient de souligner que non seulement les \"points d\'ancrage\" ne sont pas gérés par le processus clone/update, mais aussi les caches, les rerere, etc. Donc, pour une sauvegarde stricte,', 'En attente', 0, 4, '2021-12-15 16:52:12'),
                                                                                                                    (5, 2, 0, 'Formation exterieur', 'Sehe vient de souligner que non seulement les \"points d\'ancrage\" ne sont pas gérés par le processus clone/update, mais aussi les caches, les rerere, etc. Donc, pour une sauvegarde stricte,', 'En attente', 0, 5, '2021-12-15 16:52:52'),
                                                                                                                    ...
                                                                                                                    (7, 2, 0, 'Formation exterieur', 'Sehe vient de souligner que non seulement les \"points d\'ancrage\" ne sont pas gérés par le processus clone/update, mais aussi les caches, les rerere, etc. Donc, pour une sauvegarde stricte,', 'En attente', 0, 7, '2021-12-15 16:57:29'),
                                                                                                                    (8, 2, 0, 'Formation exterieur', 'Sehe vient de souligner que non seulement les \"points d\'ancrage\" ne sont pas gérés par le processus clone/update, mais aussi les caches, les rerere, etc. Donc, pour une sauvegarde stricte,', 'En attente', 0, 8, '2021-12-15 16:57:40'),
                                                                                                                    (9, 2, 0, 'Formation exterieur', 'Sehe vient de souligner que non seulement les \"points d\'ancrage\" ne sont pas gérés par le processus clone/update, mais aussi les caches, les rerere, etc. Donc, pour une sauvegarde stricte,', 'En attente', 0, 9, '2021-12-15 16:57:57'),
                                                                                                                    (10, 2, 0, 'Formation exterieur', 'Sehe vient de souligner que non seulement les \"points d\'ancrage\" ne sont pas gérés par le processus clone/update, mais aussi les caches, les rerere, etc. Donc, pour une sauvegarde stricte,', 'En attente', 0, 10, '2021-12-15 16:58:41'),
                                                                                                                    (11, 2, 0, 'Formation exterieur', 'Sehe vient de souligner que non seulement les \"points d\'ancrage\" ne sont pas gérés par le processus clone/update, mais aussi les caches, les rerere, etc. Donc, pour une sauvegarde stricte,', 'En attente', 0, 11, '2021-12-15 17:00:27'),
                                                                                                                    (12, 2, 0, 'Formation exterieur', 'Sehe vient de souligner que non seulement les \"points d\'ancrage\" ne sont pas gérés par le processus clone/update, mais aussi les caches, les rerere, etc. Donc, pour une sauvegarde stricte,', 'En attente', 0, 12, '2021-12-15 17:11:36');
