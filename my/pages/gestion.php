<section class="blc-account-management">
    <section class="nav-account-management">
        ...
        <div class="blc-search-account-svg-filtre-btn">
            <div class="blc-search-account-svg">
                <input type="text" name="search" id="" class="search-account-management" placeholder="Tapez votre ...">
    ...
    <section class="title-list-gestion">
             <div class="contain-name-firstname">
                <p class=" filter-modified-account name-firstname-gestion ">Nom et Prénom</p>
            </div>
            ...
            <div class="contain-status">
                <p class=" filter-modified-account status-gestion ">Status</p>
            </div>
    </section>
    ...
    <section class="info-account-list">
        ...
        <div class="blc-all-list">
            <div class="part-all-info-account-list">
                <div class="contain-icon-name-firstname list">
                    <div class="icon-profile red">K</div>
                    <p class="list-name-firstname">Kevin Jashari</p>
                </div>
                    <div class="contain-identifiant list">
                            <div class="list-identifiant list">kjashari</div>
                    </div>
                        <div class="contain-email list">
                            <div class="list-email list">kevin.jashari@support.com</div>
                        </div>
                    <div class="contain-grade list">
                        <div class="list-grade list">Administrateur</div>
                    </div>
                <div class="contain-grade list">
                        <input class='list'type="checkbox" id="toggle">
                </div>
            </div>
        ...
        <div class="blc-all-list">
            <div class="part-all-info-account-list">
                <div class="contain-icon-name-firstname list">
                    ...
                    <div class="contain-grade list">
                        <div class="list-grade list">Admin</div>
                    </div>
                <div class="contain-grade list">
                        <input class='list'type="checkbox" id="toggle">
                </div>
        ...
        <div class="blc-all-list">
            <div class="part-all-info-account-list">
                <div class="blc-icon-name-firstname list">
                    <div class="icon-profile red">K</div>
                    <p class="list-name-firstname">Kevin Jashari</p>
                </div>
                        <div class="list-identifiant list">kjashari</div>
                    <div class="list-email list">kevin.jashari@support.com</div>
                <div class="list-grade list">Admin</div>
                <input class='list'type="checkbox" id="toggle" class="toggle--checkbox">
