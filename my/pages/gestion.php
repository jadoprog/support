<section class="blc-account-management">
    ...
    <section class="info-account-list">
        ...
        <!-- PARTIE NAME FIRSTNAME ICON -->

        <div class="blc-all-name-firstame">
        ...
        <div class="blc-all-input">

            <div class="part-all-input">
                <input class='list-input'type="checkbox" id="">
            </div>
            <div class="part-all-input">
                <input class='list-input'type="checkbox" id="">
            </div>
